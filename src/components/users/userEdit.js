...
import { MyProfile, About, Bio,Password,Website,Save,EditProfile,Company,Username,UsersCountryMenu,AboutMe,UpdateProfile,UsersTableTitle,FirstName,LastName,Address,EmailAddress,PostalCode,Country, UsersTableHeader,City,Edit,Update,Delete} from '../../constant'
import { firebase_app } from '../../data/config';
const UserEdit = () => {

    const [data,setData] = useState([])

    const userName = firebase_app.auth().currentUser.displayName;
