import {
    ...
    FolderPlus,
    File,
    Command, Cloud, Book, FileText, Server, Image, Sliders, Map, GitPullRequest, Calendar, Edit, Mail, MessageSquare, UserCheck, Layers, HelpCircle, Database, Headphones, Mic, ShoppingBag, Search, AlertOctagon, Lock, Briefcase, BarChart,Target, List, Package, User, ArrowLeftCircle
} from 'react-feather';
...
//             { path: '/charts/chartist-chart', type: 'link', title: 'Chartist Chart' },
//         ]
//     },
//     {
...
export const MENUITEMS = [
    {
        title: 'Dashboard', icon: Home, type: 'link', path: '/dashboard', active: false, bookmark: true
    },
    {
        title: 'Profile', icon: User, type: 'link', path: '/users/userEdit', active: false, bookmark: true
    },
    {
